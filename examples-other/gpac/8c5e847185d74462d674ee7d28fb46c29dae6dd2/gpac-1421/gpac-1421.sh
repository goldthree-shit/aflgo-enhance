...
cd /home/gpac; 
git reset --hard 8c5e847185d74462d674ee7d28fb46c29dae6dd2^
...
python3 $AFLGO/scripts/git_line_changes.py \
                 --output_file $TMP_DIR/BBtargets.txt \
                 --diff_file $AFLGO/examples-other/gpac/8c5e847185d74462d674ee7d28fb46c29dae6dd2/gpac-1421/ccpatch.diff
# 编译
cd obj-aflgo; 
...
# -d 跳过确定性突变阶段（增快速度）
# @@: 输入文件
$AFLGO/afl-2.57b/afl-fuzz -m none -z exp -c 45m -i in -o out -t 2000+ ./bin/gcc/MP4Box -dash 1000 @@
