...
cd /home/gpac
git reset --hard 1ab4860609f2e7a35634930571e7d0531297e090^
...
python3 $AFLGO/scripts/git_line_changes.py --repo_path $SUBJECT \
                 ...
                 --version 98b727637e32d1d4824101d8947e2dbd573d4fc8 \
                 --pre_version 1ab4860609f2e7a35634930571e7d0531297e090^
cd obj-aflgo; 
