...
cd /home/gpac
git reset --hard 51cdb67ff7c5f1242ac58c5aa603ceaf1793b788^
...
python3 $AFLGO/scripts/git_line_changes.py --repo_path $SUBJECT \
                 ...
                 --version 51cdb67ff7c5f1242ac58c5aa603ceaf1793b788 
cd obj-aflgo; 
...
# -d 跳过确定性突变阶段（增快速度）
# @@: 输入文件
$AFLGO/afl-2.57b/afl-fuzz -m none -z exp -c 45m -i in -o out -t 1000+ ./bin/gcc/MP4Box -info @@